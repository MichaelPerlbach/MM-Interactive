...
class	AreaController	extends	\TYPO3\CMS\Extbase\Mvc\Controller\ActionController	{
	...
	*/
	public function listAction() {
		$frontendUser = $this->feusersRepository->findByUid(6);
		// \MikelMade\Mminteractive\Utility\Tx_Mminteractive_Utility_Div::debug('frontendUser',print_r($frontendUser,true),$new);
		$this->view->assign('test', $frontendUser->getUsername()); 
	}
