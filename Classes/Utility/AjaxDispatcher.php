...
namespace MikelMade\Mminteractive\Utility;
     ...
     * Copyright notice
     *
     * 2016 Michael Perlbach <info@mikelmade.de>
     * All rights reserved
     *
     *
...
class AjaxDispatcher
{
    ...
    /**
     * @param null $pageUid
     * @return Tx_Mminteractive_Utility_AjaxDispatcher
     */
    ...
    protected function setRequestArgumentsFromGetPost()
    {
        ...
        foreach ($validArguments as $argument) {
            if (t3lib_div::_GP($argument)) {
                $this->requestArguments[$argument] = t3lib_div::_GP($argument);
            }
        }
    }
