 ...
 \TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule('MikelMade.' . $_EXTKEY,            # Extension-Key
   ...
   Array(
	...
	\TYPO3\CMS\Extbase\Utility\ExtensionUtility::registerModule(
		'MikelMade.' . $_EXTKEY,
		'mminteractive',	 // Make module a submodule of 'mminteractive'
		'mod1',	// Submodule key
		'1',						// Position
		array(
			'Map' => 'list',
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addStaticFile($_EXTKEY, 'Configuration/TypoScript', 'mminteractive');
