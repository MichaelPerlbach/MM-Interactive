# -*- coding: utf-8 -*-
#
# mminteractive documentation build configuration file, created by
# TYPO3 extension sphinx on Sun, 06 Mar 2016 12:16:01 +0100.
#
...
project = u'mminteractive'
copyright = u'2016, Michael Perlbach'
...
htmlhelp_basename = 'mminteractivedoc'
...
latex_documents = [
    ('Index', 'mminteractive.tex', u'mminteractive',
     u'Michael Perlbach', 'manual'),
]
...
pdf_documents = [
    ('Index', 'mminteractive', u'mminteractive',
     u'Michael Perlbach'),
]
...
texinfo_documents = [
    ('Index', 'mminteractive', u'mminteractive',
     u'Michael Perlbach', 'mminteractive', 'One line description of project.',
     'Miscellaneous'),
]
